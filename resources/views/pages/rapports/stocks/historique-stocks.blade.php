            ...
            <table id="example1" class="table table-hover align-middle mb-0" id="livraisonsTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-light text-dark">{{$article->inventaire?->id}} | {{$article->inventaire_date?Carbon\carbon::parse($article->inventaire_date)->locale('fr')->isoFormat("D MMMM YYYY H:m:s"):'---'}} </span></td>
