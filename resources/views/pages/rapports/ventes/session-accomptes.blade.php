...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form id="sessionForm" class="row g-3 align-items-end" action="{{ route('vente.sessions-accomptes.rapport') }}" method="GET">
                <div class="col-md-4">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted fw-normal mb-2">Total Accomptes</h6>
                            <h3 class="mb-0">{{ number_format($session->accompteClients()->count(), 0, ',', ' ') }} F</h3>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted fw-normal mb-2">Total montant accomptes </h6>
                            <h3 class="mb-0">{{ number_format($session->accompteClients()->sum('montant'), 0, ',', ' ') }} F</h3>
                        </div>
                ...
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            ...
                            Accomptes <span class="badge bg-primary ms-2">{{ $session->accompteClients->count() }}</span>
                        </h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="example1">
                            ...
                            <tbody>
                                @foreach($session->accompteClients as $accompte)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        caisse: {{$accompte->sessionCaisse->caisse?->libelle}}/
                                        Ouverture: {{$accompte->sessionCaisse?->montant_ouverture}} -
                                        Fermeture: {{$accompte->sessionCaisse->montant_fermeture??00}}
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-{{ $accompte->validated_by ? 'success' : 'warning' }} rounded-pill">
                                            ...
                                            {{ $accompte->validated_by ? 'Vaildée' : 'Pas validée' }}
                                        </span>
                                    </td>
...
<script>
    $(document).ready(function() {
        ...
        $('#sessionForm').on('submit', function(e) {
            ...
            window.location.href = `{{ route('vente.sessions-accomptes.rapport') }}?${searchParams.toString()}`;
        });
    });
