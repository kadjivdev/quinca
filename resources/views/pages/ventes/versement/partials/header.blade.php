                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Gestion des versements chèque & momos</h5>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total Versements</h6>
                                <small class="text-muted">Tous les versements</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ $versements->count() }}</h4>
                            <small class="text-success">
                                <i class="fas fa-calendar-check me-1"></i>
                                {{ $versements->where('date_op', now()->format('Y-m-d'))->count() }} aujourd'hui
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">
                                {{ number_format($versements->where('date_op', now()->format('Y-m-d'))->sum('montant'), 0, ',', ' ') }}
                            </h4>
