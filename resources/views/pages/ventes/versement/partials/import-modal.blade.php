<div class="modal fade" id="importClientModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Importer des Clients</h5>
            ...
            <form action="{{ route('vente.clients.import') }}" method="POST" id="importClientForm" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4">
                    <div class="text-center mb-4">
                        <a href="{{ route('vente.clients.template.download') }}" class="btn btn-light btn-sm">
