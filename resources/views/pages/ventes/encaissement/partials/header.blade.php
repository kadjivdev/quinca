                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Liste des ventes de session</h5>
                            <div class="d-flex gap-2 align-items-center ms-3">
                                <span class="badge bg-success bg-opacity-10 text-success rounded-pill">
                                    <i class="fas fa-door-open me-1"></i>
                                    {{ count($ventes) }} ventes totales
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total Vente</h6>
                                <small class="text-muted">Aujourd'hui</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ $ventes->count() }}</h4>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total Encaissés</h6>
                                <small class="text-muted">Session</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ count($encaisses) }} ventes ({{ number_format($ttc_encaisses, 0, ',', ' ') }}F)</h4>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total Non Encaissé</h6>
                                <small class="text-muted">En cours</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ count($non_encaisses) }} ventes ({{ number_format($ttc_non_encaisses, 0, ',', ' ') }}F)</h4>
