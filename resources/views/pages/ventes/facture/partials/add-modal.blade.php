                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" name="type_facture" id="type_facture" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="d-flex justify-content-end align-items-center">
                                                    <div class="text-end">
                                                        <h3 id="messageRestant" class="fs-6 text-muted mb-1">Montant à régler</h3>
                                                        <h2 id="montantRestant" class="fs-3 fw-bold mb-0">0,00 FCFA</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<template id="ligneFactureTemplate">
    <tr class="ligne-facture">
        <td>
            ...
            <!-- <input type="number" hidden name="lignes[__INDEX__][stock]" class="form-control"> -->
