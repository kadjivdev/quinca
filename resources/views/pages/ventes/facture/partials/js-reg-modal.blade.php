...
document.addEventListener('DOMContentLoaded', function() {
    ...
    montantInput.addEventListener('input', function() {
        ...
        const montantRestant = parseFloat(document.getElementById('montantRestant').getAttribute('data-montant')) || 0;
...
function addPayment(factureId) {
    ...
    fetch(`${apiUrl}/vente/factures/${factureId}`, {
        method: 'GET',
        headers: {
...
document.getElementById('addReglementForm')?.addEventListener('submit', function(e) {
    ...
    fetch(`${apiUrl}/vente/reglement/store`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
        },
