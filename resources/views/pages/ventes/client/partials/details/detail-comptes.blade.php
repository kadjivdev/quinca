                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Règlement de facture client : {{$compte->reglementClient?->facture?->id}} <span class="badge bg-light text-dark">{{$compte->reglementClient?->numero}}</span> | <span class="badge bg-light text-dark border">{{ $compte->reglementClient?->reference_preuve }} / {{ $compte->reglementClient?->facture?->reference_recu }}</span>
                                    @endif
