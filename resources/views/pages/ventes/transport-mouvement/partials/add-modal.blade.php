<div class="modal fade" id="addTransportMouvementModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Nouveau mouvement de transport</h5>
                        <p class="text-muted small mb-0">Enregistrement d'un mouvement de transport</p>
                    </div>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="#" method="POST" id="addTransportMouvementForm" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <select class="form-select select2" name="transportation_id" required>
                                                <option value="">Sélectionner un moyen de transport</option>
                                                @foreach($transportations as $transportation)
                                                <option value="{{$transportation->id}}">{{ $transportation->matricule }}</option>
                                                @endforeach
                                            </select>
...
<script>
    $(".select2").select2({
        theme: 'bootstrap-5',
        width: '100%',
        dropdownParent: $('#addTransportMouvementModal')
    })
</script>
@endpush