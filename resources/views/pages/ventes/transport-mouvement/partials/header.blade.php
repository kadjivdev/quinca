    ...
    <div class="container-fluid p-0">
        ...
        <div class="row align-items-center mb-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Gestion des mouvements de transport</h5>
                            <div class="d-flex gap-2 align-items-center ms-3">
                                <span class="badge bg-success bg-opacity-10 text-success rounded-pill">
                                    <i class="fas fa-calendar-alt me-1"></i>
                                    {{ $mouvements->whereBetween('date', [now()->startOfMonth(), now()->endOfMonth()])->count() }} ce mois
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-auto d-flex gap-2">
                <a href="{{route('transport-mouvements.index')}}" type="button" class="btn btn-light px-3 d-inline-flex align-items-center" onclick="refreshPage()">
                ...
                <button type="button"
                    ...
                    data-bs-target="#addTransportMouvementModal">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total mouvement</h6>
                                <small class="text-muted">Tous les mouvements</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ $mouvements->count() }}</h4>
                            <small class="text-success">
                                <i class="fas fa-calendar-check me-1"></i>
                                {{ $mouvements->where('date_op', now()->format('Y-m-d'))->count() }} aujourd'hui
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ number_format($stats["total_montant"], 0, ',', ' ') }}</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">
                                {{ number_format($stats["montant_mois"], 0, ',', ' ') }}
                            </h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">
                                {{ number_format($mouvements->where('date_op', now()->format('Y-m-d'))->sum('montant'), 0, ',', ' ') }}
                            </h4>
