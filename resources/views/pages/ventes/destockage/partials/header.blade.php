    ...
    <div class="container-fluid p-0">
        ...
        <div class="row align-items-center mb-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Gestion des destockages</h5>
            ...
            <div class="col-auto d-flex gap-2">
                <a href="{{route('destockages.index')}}" class="btn btn-light px-3 d-inline-flex align-items-center" onclick="refreshPage()">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total destockages</h6>
                                <small class="text-muted">Tous les destockages</small>
                            </div>
                        </div>
