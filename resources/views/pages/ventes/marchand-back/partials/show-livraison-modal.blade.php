                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                <h6 class="card-title mb-3">
                                    <i class="fas fa-user me-2"></i>Dépot source(magasin d'ou vient la marchandise à la base)
                                </h6>
                                <div class="text-muted small" id="depotSourceLib"></div>
                                <div class="text-muted small" id="depotSourceAdr"></div>
                            </div>
                        </div>
                    </div>
                </div>
