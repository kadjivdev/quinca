<script>
    ...
    const FactureConfig = {
        routes: {
            searchArticles: '/api/articles/search',
            getTarifs: 'ventes-speciales/articles/:id/tarifs',
            getUnites: 'ventes-speciales/articles/:id/unites',
            store: 'ventes-speciales',
            validate: 'ventes-speciales/:id/validate',
            cancel: 'ventes-speciales/:id/cancel'
        },
        selectors: {
