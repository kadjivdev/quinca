...
<template id="updateLigneFactureTemplate">
    <tr class="ligne-facture">
        ...
        <td>
            <div class="input-group">
                <input type="number" class="" name="lignes[__INDEX__][quantite]" placeholder="0.00" required
                    min="0.01" step="0.01">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.loadFactureData = async function(factureId) {
            try {
                const response = await fetch(`${apiUrl}ventes-speciales/factures/${factureId}`);
                ...
                if (data.status === 'success') {
                    ...
                    for (let i = 0; i < facture.lignes.length; i++) {
                        ...
                        const tarifsResponse = await fetch(`${apiUrl}/ventes-speciales/factures/articles/${ligne.article.id}/tarifs`);
                        ...
                        const unitesResponse = await fetch(`${apiUrl}/ventes-speciales/factures/articles/${ligne.article.id}/unites`);
                        ...
                        lineEl.querySelector('[name$="[tarification_id]"]').value = ligne
                            .prix_unitaire_ht;
        ...
        updateForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(`${apiUrl}/ventes-speciales/factures/${factureId}/update`, {
                    method: 'POST',
                    body: formData
                });
    ...
    function initializeSelect2() {
        ...
        $('.select2-articles').select2({
            ...
            placeholder: 'Sélectionner un article',
            ajax: {
                url: `${apiUrl}/ventes-speciales/articles/search`,
                dataType: 'json',
                delay: 250,
