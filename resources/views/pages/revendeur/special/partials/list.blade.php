...
<script>
    ...
    async function showProforma(factureId) {
        ...
        $("#modalForm").attr("action", `/revendeurs/ventes-speciales/${factureId}/print`)
    }
    ...
    async function showBon(factureId) {
        ...
        $("#modalForm").attr("action", `/revendeurs/ventes-speciales/${factureId}/bon-a-livrer`)
    }
    ...
    async function showBordereau(factureId) {
        $("#check-logo").addClass("d-none")
        $("#check-entete").removeClass("d-none")
        $("#modalForm").attr("action", `/revendeurs/ventes-speciales/${factureId}/bordereau-livraison`)
    }
...
<script>
    ...
    function filterFactures() {
        ...
        $.ajax({
            url: `${apiUrl}/ventes-speciales/clients/filter?` + params.toString(),
            method: 'GET',
