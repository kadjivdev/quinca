...
@section('content')
    <div class="content">
        @include('pages.revendeur.special.partials.header')
        <div class="row g-3 list mt-3" id="stockEntriesList">
            @include('pages.revendeur.special.partials.list')
        </div>
    </div>

    @include('pages.revendeur.special.partials.add-modal')
    @include('pages.revendeur.special.partials.edit-modal')
    @include('pages.revendeur.special.partials.show-modal')
    @include('pages.revendeur.special.partials.add-reg-modal')
@endsection
