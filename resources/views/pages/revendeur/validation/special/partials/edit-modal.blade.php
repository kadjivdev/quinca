        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-warning bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    <div class="bg-warning bg-opacity-10 p-2 rounded-circle me-3">
                        <i class="fas fa-file-invoice fs-4 text-warning"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Modification de Facture de vente spéciale <span id="factIdMod"></span></h5>
            ...
            <form action="" method="POST" id="editFactureForm" class="needs-validation">
                            ...
                            <div class="col-12">
                                <div class="card border border-light-subtle">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <p class="text-muted mb-1">Numéro Facture</p>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <p class="fw-medium mb-0" id="ClientMod"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" class="form-control" name="date_facture" required readonly>
                            ...
                            <div class="col-12">
                                <div class="card border border-light-subtle">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-9">
                                            <label class="form-label fw-medium required">Commentaire</label>
                ...
                <div class="modal-footer bg-light border-top-0 py-3">
                    ...
                    <button type="submit" class="btn btn-warning px-4" id="btnSave">
