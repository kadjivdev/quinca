...
{{-- 
            <form action="{{ route('factures.store') }}" method="POST" id="addFactureForm" class="needs-validation"
                                ...
                                <div class="card border border-light-subtle">
                                    <div class="card-header bg-light">
                                        <h6 class="card-title mb-0">
                                            <i class="fas fa-info-circle me-2"></i>Informations Facture
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <p class="fw-medium mb-0" id="ClientShow"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer bg-light border-top-0 py-3">
                    ...
                    {{-- <button type="submit" class="btn btn-warning px-4" id="btnSave" style="display: none;">
        ...
        $(document).ready(function() {
            ...
            $('#bonCommandeSelect').change(function() {
                ...
                if (option.val()) {
                    ...
                    $.ajax({
                        url: `/achat/bon-commandes/${option.val()}/articles`,
                        method: 'GET',
