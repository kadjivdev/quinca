...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-5">
        <h2 class="font-weight-bold text-dark">
            <i class="fas fa-cash-register me-2"></i>Ventes Spéciales
        </h2>
    </div>
                        ...
                        <table class="table table-hover" id="facturesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $vente->client->raison_sociale }}</td>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-light-success btn-icon ms-1"
                                                    onclick="validateVente({{ $vente->id }})"
...
@include('pages.revendeur.validation.special.partials.edit-modal')
@include('pages.revendeur.validation.special.partials.show-modal')
@endsection
...
@push('scripts')
    <script>
        ...
        async function validateVente(id){
            try {
                const result = await Swal.fire({
                    title: 'Êtes-vous sûr ?',
                    text: "Voulez-vous valider cette vente ?",
                    icon: 'warning',
    ...
    @include('pages.revendeur.validation.special.partials.scripts')
@endpush
