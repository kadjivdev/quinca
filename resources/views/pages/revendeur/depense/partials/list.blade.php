            ...
            <div class="table-responsive">
                <table id="example1" class="table table-hover align-middle mb-0" id="facturesTable">
                    <thead class="bg-light">
                        <tr>
                            <th class="border-bottom-0 text-nowrap py-3">N° Depense</th>
                        ...
                        <tr>
                            <td class="text-nowrap py-3">
                                <div class="d-flex align-items-center">
                                    <span class="numero-facture me-2">{{ $depense->numero }}</span>
                                </div>
                            </td>
                            <td>
                                <span class="badge bg-dark text-white">{{$depense->depot?->libelle_depot}}</span>
                            </td>
                            <td>{{ Carbon\Carbon::parse($depense->created_at)->format('d/m/Y H:i:s') }}</td>
                            <td>{{ $depense->day->format('d/m/Y') }}</td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-sm btn-light-primary btn-icon"
                                        onclick="showFacture({{ $depense->id }})"
                                    ...
                                    <button class="btn btn-sm btn-light-warning btn-icon ms-1"
                                        onclick="editFactures({{ $depense->id }})"
                                    ...
                                    <button class="btn btn-sm btn-light-danger btn-icon ms-1"
                                        onclick="deleteFacture({{ $depense->id }})"
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <h6 class="text-muted mb-1">Aucune dépense trouvée</h6>
                                    <p class="text-muted small mb-3">Les dépenses que vous créez apparaîtront ici</p>
                                    <button class="btn btn-primary btn-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#addDepenseModal">
                                        <i class="fas fa-plus me-2"></i>Inserer une dépense
                                    </button>
                                </div>
                            </td>
                        </tr>
    ...
    function deleteFacture(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`${apiUrl}/revendeurs/depenses/${id}/destroy`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': token,
