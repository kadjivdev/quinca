    ...
    <div class="container-fluid p-0">
        ...
        <div class="row align-items-center mb-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Gestion des dépenses</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto d-flex gap-2">
                <a href="{{route('revendeur.depenses.index')}}" class="btn btn-light px-3 d-inline-flex align-items-center">
        ...
        <div class="row g-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">Montant dépenses</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i>
                                {{ number_format($totalDepenses ?? 0, 2, '.', ' ') }} F
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">Total des ventes</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i>
                                {{ number_format($totalVenteAmount ?? 0, 2, '.', ' ') }} F
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-3 d-flex justify-content-center g-4">
            <div class="col-xl-10">
                <div class="card rounded">
                    <div class="card-body border">
                        <p class="text-center">Recette à verser pour la journée du <span class="badge bg-primary"> {{\Carbon\Carbon::parse($day)->locale('fr')->isoFormat('dddd D MMMM YYYY')}}</span> = {{number_format($recetteTotale,2,'.',' ')}} FCFA</p>
                    </div>
                </div>
            </div>
        </div>
