...
routes: {
articlesSearch: '/revendeurs/factures/api/articles/search',
getTarifs: (id) => `/revendeurs/factures/articles/${id}/tarifs`,
getUnites: (id) => `/revendeurs/factures/articles/${id}/unites`,
store: '/revendeurs/factures/store'
},
select2Options: {
theme: 'bootstrap-5',
width: '100%',
