<div class="modal fade" id="editFamilleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            ...
            <form action="" method="POST" id="editFamilleForm" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="code_famille" pattern="[A-Z0-9]{6}"
                                    required maxlength="6" placeholder="AUTO123" readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="libelle_famille" required minlength="3"
                                maxlength="100" placeholder="Ex: Pièces Automobiles">
                            <div class="invalid-feedback">
