<div class="modal fade" id="importArticleModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Importer des tarifications</h5>
            ...
            <form action="{{ route('tarification.import') }}" method="POST" id="importArticleForm" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4">
                    <div class="text-center mb-4">
                        <a target="_blank" href="{{ asset('model-tarifs.xlsx')}}" class="btn btn-light btn-sm">
                    ...
                    <div class="alert alert-info mb-0">
                        ...
                        <ul class="mb-0 ps-3">
                            ...
                            <li>Vérifiez que les articles existent</li>
                        </ul>
                    </div>
                </div>
