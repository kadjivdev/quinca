        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="modal-title fw-bold">Modifier Vehicule</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('vehicule.store') }}" method="POST" id="editVehiculeForm"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="actif" id="statusSwitchMod"
                                    value="1" checked>
