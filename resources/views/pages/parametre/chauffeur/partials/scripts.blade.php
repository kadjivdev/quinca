<script>
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('addChauffeurForm');
        const modal = document.getElementById('addChauffeurModal');
    ...
    async function editChauffeur(id) {
        try {
            ...
            const response = await fetch(`chauffeurs/${id}/edit`, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
            ...
            if (result.success) {
                const editModal = document.getElementById('editChauffeurModal');
                const editForm = document.getElementById('editChauffeurForm');

                // Mettre à jour l'action du formulaire
                editForm.action = `chauffeurs/${id}`; // Changement ici

                editForm.querySelector('[name="nom"]').value = result.data.nom_chauf;
                editForm.querySelector('[name="telephone"]').value = result.data.telephone || '';
                editForm.querySelector('[name="num_permis"]').value = result.data.numero_permis || '';
    ...
    document.getElementById('editChauffeurForm')?.addEventListener('submit', async function(e) {
        e.preventDefault();
        ...
        try {
            ...
            if (result.success) {
                ...
                Toast.fire({
                    icon: 'success',
                    title: result.message || 'Chauffeur mis à jour avec succès'
                });
    ...
    async function deleteChauffeur(id) {
        try {
            ...
            if (result.isConfirmed) {
                Toast.fire({
                    icon: 'success',
                    title: result.value.message || 'Chauffeur supprimé avec succès'
                });
