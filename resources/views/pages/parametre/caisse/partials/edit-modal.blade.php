<!-- Modal de modification de caisse -->
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-header bg-light border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="modal-title fw-bold" id="editCaisseModalLabel">Modifier la Caisse</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Corps du modal -->
            <form id="editCaisseForm" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                <div class="modal-body p-4">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="point_vente_id" required>
