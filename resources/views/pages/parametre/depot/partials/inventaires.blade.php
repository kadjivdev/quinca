                ...
                <table class="table table-hover align-middle mb-0" id="example1">
                    ...
                    <tbody class="">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="badge bg-light text-dark">{{\Carbon\carbon::parse($inventaire->date_inventaire)->locale('fr')->isoFormat('dddd D MMMM YYYY à HH:mm:ss')}}</span></td>
