        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="modal-title fw-bold">Modifier le Magasin</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="" method="POST" id="editDepotForm" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                <div class="modal-body p-4">
                    <div class="row g-4">
                        {{-- Code Magasin (lecture seule) --}}
                        <div class="col-md-6">
                            <label class="form-label fw-semibold required">Code Magasin</label>
                            <input type="text" class="form-control" name="code_depot" readonly>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="adresse_depot" rows="3"></textarea>
                        </div>
                            ...
                            <div>
                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input" name="depot_principal"
                                        id="editDepotPrincipal">
                                    <label class="form-check-label" for="editDepotPrincipal">
                                        Définir comme magasin principal
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="actif" id="editDepotActif">
                                    <label class="form-check-label" for="editDepotActif">
                                        Magasin actif
                                    </label>
                                </div>
                            </div>
