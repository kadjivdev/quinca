<!-- Modal de modification de point de vente -->
<div class="modal fade" id="editPointVenteModal" tabindex="-1" aria-labelledby="editPointVenteModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-header bg-light border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="modal-title fw-bold" id="editPointVenteModalLabel">Modifier le Point de Vente</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Corps du modal -->
            <form id="editPointVenteForm" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="actif" id="editStatusSwitch">
