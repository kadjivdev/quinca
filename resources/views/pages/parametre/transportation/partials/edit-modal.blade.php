<div class="modal fade" id="editTransportationModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    <i class="fas fa-car fs-4 text-primary me-2"></i>
                    <h5 class="modal-title fw-bold">Modifier un moyen de transport</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="#" method="POST" id="editTransportationForm"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <select class="form-select select2" name="type" id="edit_type_transport"
                                    required>
