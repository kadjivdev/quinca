...
<div class="row g-3">
    {{-- Table des moyens de transports --}}
    <div class="col-12">
                ...
                <table id="example1" class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="border-bottom-0 text-nowrap py-3">Matricule</th>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap py-3">
                                <div class="d-flex align-items-center">
                                    <span class="code-programmation me-2">{{ $transportation->matricule }}</span>
                                </div>
                            </td>
                            <td>{{ $transportation->libelle }}</td>
                            <td>{{ $transportation->type }}</td>
                            <td class="text-end">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-light-warning btn-icon ms-1"
                                        onclick="editTransportation({{ $transportation->id }})"
