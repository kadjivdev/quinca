                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="mb-0 fw-bold">Gestion des Avances</h5>
                            <div class="d-flex gap-2 align-items-center ms-3">
                                <span class="badge bg-success bg-opacity-10 text-success rounded-pill">
                                    <i class="fas fa-calendar-alt me-1"></i>
                                    {{ $avances
                                        ->whereNotNull("validated_by")
                                        ->whereBetween('date', [now()->startOfMonth(), now()->endOfMonth()])->count() }} ce mois
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-0">Total Avances</h6>
                                <small class="text-muted">Tous les avances</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ $avances->whereNotNull("validated_by")->count() }}</h4>
                            <small class="text-success">
                                <i class="fas fa-calendar-check me-1"></i>
                                {{ $avances->whereNotNull("validated_by")->where('date', now()->format('Y-m-d'))->count() }} aujourd'hui
                            </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <small class="text-muted">Totes les avances</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">{{ number_format($avances->whereNotNull("validated_by")->sum('montant'), 0, ',', ' ') }}</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">
                                {{ number_format($avances->whereNotNull("validated_by")->whereBetween('date', [now()->startOfMonth(), now()->endOfMonth()])->sum('montant'), 0, ',', ' ') }}
                            </h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-baseline">
                            <h4 class="mb-0 me-2">
                                {{ number_format($avances->whereNotNull("validated_by")->where('date', now()->format('Y-m-d'))->sum('montant'), 0, ',', ' ') }}
                            </h4>
