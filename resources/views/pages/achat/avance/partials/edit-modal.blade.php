        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Modifier l'avance</h5>
                        <p class="text-muted small mb-0">Modification des informations de l'avance</p>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select select2-edit" name="fournisseur_id" id="edit_client_id" required>
