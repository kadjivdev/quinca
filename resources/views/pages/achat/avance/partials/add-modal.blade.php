        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary bg-opacity-10 border-bottom-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Nouvel Avance</h5>
                        <p class="text-muted small mb-0">Enregistrement d'une avance fournisseur</p>
                    </div>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{route('achat.avances.store')}}" method="POST" id="addAcompteForm" class="needs-validation" novalidate>
                @csrf
                            ...
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <h6 class="card-subtitle mb-3 text-muted">
                                        <i class="fas fa-info-circle me-2"></i>Informations de l'avance
                                    </h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select select2" name="fournisseur_id" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" name="observation" rows="2"
                                                placeholder="Observation ou note concernant l'avance"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
