...
<script>
    ...
    function deleteAcompte(id) {
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                        url: `${apiUrl}/achat/acomptes-frs/${id}`,
                        type: 'DELETE',
                        headers: {
                            ...
                            <div class="text-start">
                                <table id='example1' class="table table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>${acompte.fournisseur.code_fournisseur} - ${acompte.fournisseur.raison_sociale}</td>
                                    </tr>
                                    <tr>
...
<script>
    ...
    function validateAcompte(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `${apiUrl}/achat/acomptes-frs/${id}/validate`,
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
    ...
    function rejectAcompte(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `${apiUrl}/achat/acomptes-frs/${id}/reject`,
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
