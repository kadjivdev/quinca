                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="header-icon">
                        <div class="icon-wrapper">
                            <i class="fas fa-clipboard-list fs-4 text-warning"></i>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <h6 class="header-title mb-0">Précommande des Achats</h6>
                            <span class="badge bg-soft-success text-success rounded-pill">
                                <i class="fas fa-check fs-xs me-1"></i>
                                {{ $programmations->whereNotNull('validated_at')->count() }} programmation(s) validée(s)
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-auto">
                <div class="quick-stat-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <div class="stat-label">Total Programmations</div>
                            <div class="stat-value">{{ $totalProgrammations }}</div>
                ...
                <div class="quick-stat-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <div class="stat-value">{{ $programmationsEnAttente }}</div>
                ...
                <div class="quick-stat-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <div class="stat-value">{{ $programmationsValidees }}</div>
                            <div class="stat-trend text-success">
                                <i class="fas fa-check"></i> Complétées
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="quick-stat-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <div class="stat-value">{{ $programmationsEnCours }}</div>
