                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Unité à livrer</th>
                ...
                articlesHtml += `
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ${article.unite || ""}
                                                    <input type="number" name="articles[${index}][quantite]" value="${article.quantite || 0}" class="form-control form-control-sm text-end" value="${article.quantite || 0}" readonly>
                                                    <input type="hidden" name="articles[${index}][unite_mesure_id]" value="${article.unite_mesure.id}" class="form-control form-control-sm text-end" value="${article.quantite || 0}" readonly>
                                                </td>
                                                <td class="text-center">
    ...
    function saveBonCommande(form) {
        ...
        $('#articlesSection table tbody tr').each(function(index) {
            data.lignes.push({
                ...
                unite_mesure_base_id: $(`select[name="articles[${index}][unite_mesure_base_id]"]`).val(),
                quantite: $(`input[name="articles[${index}][quantite]"]`).val(),

                unite_mesure_id: $(`input[name="articles[${index}][unite_mesure_id]"]`).val(),
                // quantite_base: $(`input[name="articles[${index}][quantite_base]"]`).val(),
