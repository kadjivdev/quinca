                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <input type="number" class="form-control form-control-sm text-end quantite"
                                    ...
                                    readonly>
                                    <span class="badge bg-light border text-dark">${article.unite_mesure_base?.libelle_unite}</span>
                            </td>
                            <td class="text-end">
                                <input type="number" class="form-control form-control-sm text-end quantite"
                                    ...
                                    readonly>
                                    <span class="badge bg-light border text-dark">${article.unite_mesure}</span>
                            </td>
                            <td class="text-end">
