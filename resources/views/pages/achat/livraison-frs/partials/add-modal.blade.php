        ...
        <div class="modal-content border-0 shadow-lg rounded-4 modal-dialog-scrollable" style="overflow-y: scroll!important;">
            ...
            <div class="modal-header border-0 bg-gradient-light py-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-semibold mb-1">Nouveau Bon de Livraison</h5>
            ...
            <form action="#" method="POST" id="addLivraisonFournisseurForm" class="needs-validation" novalidate>
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h6 class="fw-semibold mb-0" id="fournisseurName"></h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="modal-footer border-0 py-3 bg-light rounded-bottom-4">
                    ...
                    <button type="submit" class="btn btn-warning rounded-pill px-4" id="btnSaveLivraison" disabled>
