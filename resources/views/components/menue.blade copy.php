                ...
                <ul class="dropdown-menu navbar-dropdown-caret">
                    ...
                    <li><a class="dropdown-item" href="{{ route('rapports.mouvement-stock') }}">
                        ...
                        <li><a class="dropdown-item" href="{{ route('rapports.stock-dispo') }}">
                            <div class="dropdown-item-wrapper">Stock Disponible de Stock</div>
                        </a></li>


                    {{-- <li><a class="dropdown-item" href="{{route('stock.valorisation.index')}}">
                        <div class="dropdown-item-wrapper">Valorisation des Stocks</div>
                    </a></li> --}}
                    ...
                    <li><a class="dropdown-item" href="{{ route('rapports.etat-ventes') }}">
                            <div class="dropdown-item-wrapper">Etat des Ventes</div>
                        </a></li>
