...
Route::get("/debug", function () {
    $BLF2509170005 = BonLivraisonFournisseur::with("facture.lignes")->firstWhere("code", "BLF2509170005");

    return response()->json($BLF2509170005);

    foreach ($BLF2509170005->lignes as $ligne) {
