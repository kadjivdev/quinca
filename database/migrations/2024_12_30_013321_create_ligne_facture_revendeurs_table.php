...
return new class extends Migration
{
    ...
    {
        Schema::create('ligne_facture_revendeurs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('facture_revendeur_id')->constrained('facture_revendeurs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('ligne_facture_revendeurs');
    }
};
