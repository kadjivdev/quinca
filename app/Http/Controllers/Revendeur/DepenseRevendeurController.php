        ...
        try {
            ...
            if (
                ...
                $depenses = $query
                    ...
                    ->get();
                $depots = $user->pointDeVente->pluck("depot");
            }
            ...
            return view('pages.revendeur.depense.index', compact('depenses', 'depots', 
            'date', 'day','totalVenteAmount','totalDepenses','recetteTotale'));
