...
use App\Models\Parametre\Vehicule;
...
class VehiculeController extends Controller
{
    public function index()
    {
        ...
        $stats = [
            ...
            'vehicules_actifs' => $vehicules->where('statut', true)->count(),
        ];

        $date = Carbon::now()->locale('fr')->isoFormat('dddd D MMMM YYYY');

        return view('pages.parametre.vehicule.index', compact(
            'vehicules',
            'stats',
            'date'
        ));
    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                'matricule' => 'required|string|min:6|max:100|unique:vehicules,matricule',
                'actif' => 'boolean'
            ]);
        ...
        try {
            ...
            $validated = $request->validate([
                'matricule' => [
                    ...
                    'min:6',
                    'max:100',
                    Rule::unique('vehicules', 'matricule')->ignore($id)
                ],
            ]);
            ...
            $vehicule->statut =  $request->input('actif') === '1';
